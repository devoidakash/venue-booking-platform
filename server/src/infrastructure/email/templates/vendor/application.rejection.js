export function generateVendorRejectionTemplate({
  vendorName = 'Vendor',
  ...
  return `
		...
		<html lang="en">
			<head>
				...
				<title>Update on your Venuz vendor application</title>
			</head>
					...
					<tr>
						<td align="center">
							<table width="560" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; border: 1px solid #e4e4e7; overflow: hidden;">
								<tr>
									<td style="height: 5px; background-color: #dc2626;"></td>
								</tr>
								<tr>
									<td style="padding: 40px 40px 32px;">
										...
										<h1 style="margin: 0 0 16px; font-size: 28px; line-height: 1.2; color: #991b1b;">Your application needs attention</h1>
										<p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: #52525b;">
											We could not approve your vendor application at this time. Please review the reason below and submit a new application with the required corrections.
										</p>
